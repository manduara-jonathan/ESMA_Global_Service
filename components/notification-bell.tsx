  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-[#E8772E] text-[11px] font-bold text-white ring-2 ring-background">
