...
const serviceLinks = [
  { href: "/services/billets-avion", label: "Billets d'avion" },
  { href: "/services/visas", label: "Facilitation de visas" },
  { href: "/services/monnaie-mobile", label: "Services monnaie mobile" },
  { href: "/services/nettoyage", label: "Service de nettoyage" },
  { href: "/services/traiteur", label: "Service traiteur" },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-white/70 mb-6 text-sm leading-relaxed">
              ...
              financiers, l{"'"}entretien et la restauration.
            </p>
