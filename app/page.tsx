            ...
            <Reveal>
              ...
              <div className="flex flex-col gap-8">
                {[
                  ...
                  { icon: Mail, title: t.contact.emailLabel, value: "contact@esmaglobalservice.com", link: "mailto:contact@esmaglobalservice.com" },
                  { icon: MapPin, title: t.contact.addressLabel, value: "Commune de Kinshasa, Avenue Itaga, Quartier Ngwaka, Numéro 121", link: null },
                ].map((item) => (
