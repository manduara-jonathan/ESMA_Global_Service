            ...
            {visaTypes.map((v) => (
              <Card key={v.title} className="card-hover border-none shadow-lg bg-card text-center">
                <CardContent className="pt-8 pb-6">
                  <div className="w-16 h-16 rounded-full bg-[#0270bd]/10 flex items-center justify-center mx-auto mb-5">
                    <Stamp className="h-8 w-8 text-[#0270bd]" />
                  </div>
                  ...
                  <span className="inline-block px-3 py-1 rounded-full bg-[#e0822d]/10 text-[#e0822d] text-xs font-medium">
                    Delai : {v.duration}
                  </span>
                </CardContent>
              </Card>
